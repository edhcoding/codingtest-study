/**
 * 오픈채팅방 - https://school.programmers.co.kr/learn/courses/30/lessons/42862
 *
 * [문제 설명]
...
function solution(record) {
  ...
  for (const log of record) {
    ...
    if (action !== "Leave") userInfo[id] = nickname;
  }
  ...
  for (const log of record) {
    ...
    if (action === "Enter") {
      answer.push(`${userInfo[id]}님이 들어왔습니다.`);
    } else if (action === "Leave") {
      answer.push(`${userInfo[id]}님이 나갔습니다.`);
    }
  }
